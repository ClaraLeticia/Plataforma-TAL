    ...
    <div class="container-sm d-flex justify-content-center mt-5">
        <div class="row">
            ...
            @foreach($membros_etep as $membro_etep)
                <div class="card shadow rounded visualizar-card" style="width: 45rem;">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center float-end">
                            <a href="/perfil-etep/editar-etep/{{$membro_etep->matricula_membro}}" class="btn btn-success ms-4">Editar</a>
                            <form action="/deletar-etep/{{$membro_etep->matricula_membro}}" method="POST" onsubmit="return confirm('Tem certeza que deseja excluir esse Membro da ETEP?')">
                                @csrf
                                @method('DELETE')
