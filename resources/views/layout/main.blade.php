        ...
        <nav class="navbar navbar-expand-lg bg-light">
            <div class="container-fluid">
                ...
                <div class="navbar-nav">
                    <a class="nav-link" id="#horarios" href="/horarios">Horários</a>
                    <a class="nav-link" id="linkActive" href="/documento">Documentação</a>
                    <a class="nav-link" id="linkActive" href="/login">Login</a>
                    <a class="nav-link" id="linkActive" href="/cadastro">Cadastro</a>
                </div>
                </div>
            </div>
        </nav>
